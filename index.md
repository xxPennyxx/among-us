...
### Roles
The crewmates can be assigned the Scientist or Engineer role, depending on the percentage/ratio of those crewmates who can have the role. Those settings can be changed, of course, before the game starts.
...
### Gameplay
At the start of the game, the game decides whether you are a Crewmate or an Impostor. The players must NOT reveal their role to others. They must keep mum throughout the game, except during meetings or reports. There are upto 3 Impostors in a game of 15. 
...
### Colours
Each crewmate has a unique colour they can pick: black, blue, brown, cyan, green, lime, orange, pink, purple, red, white and yellow. Six new colours have been introduced in the June 2021 update: maroon, rose, gray, banana, tan and coral.
...
- Keep an eye on the shift cooldown meter.
